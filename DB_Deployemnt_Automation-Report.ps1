param([string]$RootPath="C:\RevenueCycle\Development\Ahtolink_3.5\DB_Projects\ACH_DB_Tran",[string]$DropLocation="C:\RevenueCycle\Development\Ahtolink_3.5\DB_Projects",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="DevPRockCI",[string] $DbList="15",[bool]$ExcludeSynonym=$true,[string]$RequestedByEmail="nasimuddin@accretivehealth.com")
