param([string]$RootPath="C:\Users\300915\Desktop\RevenueCycle\R2015.9\Care\DB_Projects\ACH_DB_NonTran",[string]$DropLocation="C:\Users\300915\Desktop\RevenueCycle\R2015.9\Care\DB_Projects",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="UAT",[bool]$DeployChanges=$false,[string] $DbList="17",[bool]$ExcludeSynonym=$true)
