param([string]$RootPath="C:\Users\300915\Desktop\RevenueCycle\R2015.6\Care\DB_Projects\ACH_DB_NonTran",[string]$DropLocation="C:\Users\300915\Desktop\RevenueCycle\R2015.6\Care\DB_Projects",[string]$BuildName=(Get-Date -format 'yyyyMMdd') +"_"+(Get-Date -format 'HHmm'),[string]$ENV="CI",[bool]$DeployChanges=$True,[string] $DbList="1",[bool]$ExcludeSynonym=$true)
